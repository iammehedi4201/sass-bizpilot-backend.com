...
export const getModeratorInvitationEmailTemplate = (link: string) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Moderator Invitation</title>
  </head>
          ...
          <table role="presentation" style="width:100%;max-width:600px;border-collapse:collapse;background-color:#ffffff;border-radius:12px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
            ...
            <tr>
              <td style="padding:40px;">
                <h1 style="margin:0 0 16px;font-size:28px;font-weight:700;color:#1a1a1a;text-align:center;">Moderator Invitation</h1>
                <p style="margin:0 0 24px;font-size:16px;line-height:1.6;color:#4a5568;text-align:center;">
                  You have been invited to join as a moderator. Click the button below to complete your registration.
                </p>
...
export const sendModeratorInvitationEmail = async (
  ...
  await sendEmail({
    to: email,
    subject: "Moderator Invitation - BizPilot",
    html: getModeratorInvitationEmailTemplate(link),
  });
};
